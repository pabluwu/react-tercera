        ...
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-6 !bg-white dark:!bg-slate-900 p-6 md:p-8 rounded-3xl shadow-sm border border-slate-100 dark:border-slate-800">
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-slate-500 dark:text-slate-400 flex items-center gap-1.5 mt-0.5 max-w-[200px] sm:max-w-none truncate">
          ...
          <div className="flex flex-wrap items-center gap-3 w-full md:w-auto justify-center md:justify-end">
            <div className="flex bg-slate-100 dark:!bg-slate-800 p-1 rounded-2xl w-full sm:w-auto justify-between sm:justify-start">
              <button 
                className="px-3 sm:px-4 py-2 text-sm font-bold text-slate-600 dark:text-slate-400 hover:text-slate-900 dark:hover:text-white transition-colors"
                onClick={handlePrevYear}
              >
                {year - 1}
              </button>
              <button
                className={`px-4 sm:px-6 py-2 rounded-xl text-sm font-bold shadow-sm transition-all ${year === currentYear ? "bg-red-600 text-white" : "!bg-white dark:!bg-slate-700 text-slate-900 dark:text-white"}`}
            ...
            <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
              <div className="flex flex-wrap items-center gap-3">
                <div className="flex items-center gap-3">
                  ...
                  <h5 className="text-xl font-bold text-slate-800 dark:text-white whitespace-nowrap">Resumen {year}</h5>
                </div>
                <span className="px-3 py-1 bg-slate-100 dark:!bg-slate-800 text-slate-500 dark:text-slate-400 rounded-full text-[10px] sm:text-xs font-bold uppercase tracking-wider">
              ...
              <button
                type="button"
                className="w-full sm:w-auto flex items-center justify-center gap-2 px-4 py-2 !bg-white dark:!bg-slate-800 text-slate-600 dark:text-slate-400 border border-slate-200 dark:border-slate-700 rounded-xl text-sm font-medium hover:border-red-500 hover:text-red-600 transition-all shadow-sm"
                onClick={() => refetch()}
              >
