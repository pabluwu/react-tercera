    ...
    return (
        <Layout>
            <div className="container mx-auto px-4 py-8 max-w-3xl">
                <div className="!bg-white dark:!bg-slate-800 rounded-3xl shadow-xl shadow-slate-200/50 dark:shadow-none border border-slate-100 dark:border-slate-700 p-8 md:p-10">
                    <div className="flex items-center gap-4 mb-10">
                        <div className="p-4 bg-red-50 dark:!bg-red-900/20 rounded-2xl text-red-600 dark:text-red-400">
                            <Upload size={32} />
                        </div>
                        <div>
                            <h2 className="text-3xl font-extrabold text-slate-800 dark:text-white tracking-tight">Subir Comprobante</h2>
                            <p className="text-slate-500 dark:text-slate-400 font-medium">Registra tu transferencia bancaria</p>
                        </div>
                    </div>
                    ...
                    <form onSubmit={handleSubmit(onSubmit)} className="space-y-10">
                        ...
                        <div className="space-y-4">
                            ...
                            <div className={`relative group border-2 border-dashed rounded-[2rem] transition-all duration-200 ${
                                errors.archivo 
                                ...
                                <div className="p-10 flex flex-col items-center justify-center text-center">
                                    <Upload size={48} className={`mb-4 transition-colors ${errors.archivo ? 'text-red-400' : 'text-slate-400 group-hover:text-red-500'}`} />
